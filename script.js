...
const table = document.getElementsByClassName("cb-table cb-table-react")[0].children[1].children;
...
function loop(i) {
    ...
    var button = table[0].cells[1].children[0];
    ...
    setTimeout(3000, () => {
        ...
        document.getElementsByClassName("cb-btn cb-btn-square cb-btn-close")
            [0].click();
    });

    setTimeout(2000, () => loop(i + 1));
} 
